...
public class secondStage2 extends BasicGameState{
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException{
		...
		if(blackhole2==true){
			sbg.enterState(8, new FadeOutTransition(Color.black, 0), new FadeInTransition(Color.white, 1000)); 
			guyPositionX = -0;
			guyPositionY = -4;
			blackhole2 = false;
		}
