...
public class secondStage3 extends BasicGameState{
	...
	public secondStage3(int state){
	}
	
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException{
		worldMap = new Image("res/secondWorld1.png");
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException{
		...
		if(shipInt==true){
			sbg.enterState(9, new FadeOutTransition(Color.black, 0), new FadeInTransition(Color.white, 1000));
		}
