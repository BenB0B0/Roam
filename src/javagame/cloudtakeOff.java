...
public class cloudtakeOff extends BasicGameState{
	...
	public cloudtakeOff(int state){
	}
	
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException{
		worldMap = new Image("res/cloudWorld.png");
	...
	public void update(GameContainer gc, StateBasedGame sbg, int delta) throws SlickException{
		...
		if(guyPositionY > -3.5){
			sbg.enterState(3, new FadeOutTransition(Color.black, 1000), null);  
		}
	}
